...
const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  return (
    <div className="p-5 pb-20">
      <div className="mb-8">
        <h2 className="text-2xl font-black text-hb-navy mb-1 italic tracking-tight uppercase">
          App Settings
        </h2>
      ...
      <div className="bg-white rounded-[24px] border border-hb-border overflow-hidden shadow-sm mb-6 p-6">
        <h3 className="text-[12px] font-black text-hb-muted uppercase tracking-widest mb-4">
          Support & Info
        </h3>
        <div className="space-y-4">
          <div className="flex justify-between items-center p-3 bg-hb-bg rounded-xl border border-hb-border/50">
            ...
            <span className="font-black text-hb-muted text-xs uppercase tracking-wide">
              3.0.1 Stable
            </span>
          </div>
          <div className="flex justify-between items-center p-3 bg-hb-bg rounded-xl border border-hb-border/50">
...
const SettingItem: React.FC<SettingItemProps> = ({
  ...
  <div className="flex items-center justify-between p-5 border-b border-hb-border last:border-0 hover:bg-slate-50 transition-colors">
    <div className="flex items-center gap-4">
      <div
        className={`w-10 h-10 rounded-full flex items-center justify-center shadow-sm ${color}`}
      >
    ...
    >
      <div
        className={`w-5 h-5 rounded-full bg-white shadow-sm transition-transform ${value ? "translate-x-5" : "translate-x-0"}`}
      />
    </button>
  </div>
);
