    ...
    <div className="p-5">
      <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-6 text-white mb-6 shadow-xl">
        ...
        <p className="text-sm opacity-80">
          Use Gemini to generate viral promotional text for your bingo streaks!
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        {promo && (
          <div className="bg-white p-6 rounded-2xl border-2 border-purple-50 shadow-inner mt-4 animate-in fade-in slide-in-from-bottom-2">
            <div className="text-xs font-black text-purple-400 uppercase mb-3">
              Script Suggestion
            </div>

            <div className="mb-3 font-black text-gray-800 text-lg leading-tight">
              {promo.title}
            </div>

            <p className="text-base text-gray-700 italic leading-relaxed whitespace-pre-wrap mb-5 font-medium">
              {promo.script}
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {promo.hashtags.map((tag, i) => (
                <span
                  key={i}
                  className="text-xs text-purple-600 font-bold bg-purple-50 px-3 py-1.5 rounded-lg"
                >
                  #{tag.replace(/^#/, "")}
                </span>
              ))}
